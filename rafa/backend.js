// ==========================================
// RAFA Hub - 后端交互与 Discord 鉴权核心逻辑
// 文件位置: rafa/backend.js
// ==========================================
...
function renderDiscordUI() {
  ...
  if(isDiscordLoggedIn) {
    ...
    // ⚠️ 核心判定：以 rafa 是否被订阅为准
    if(subCheckbox) subCheckbox.checked = isProjectTracked('rafa');
...
function toggleSubscription() {
  ...
  const projectId = 'rafa'; // 修改此处为 rafa
