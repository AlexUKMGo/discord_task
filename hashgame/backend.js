// ==========================================
// Hashgame Hub - 后端交互与 Discord 鉴权核心逻辑
// 文件位置: hashgame/backend.js
// ==========================================
...
function renderDiscordUI() {
  ...
  if(isDiscordLoggedIn) {
    ...
    // ⚠️ 核心判定：以 Hashgame 是否被订阅为准
    if(subCheckbox) subCheckbox.checked = isProjectTracked('hashgame');
